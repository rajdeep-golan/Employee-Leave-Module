...
<?php
	...
	if($fromdate > $todate)
	{
		...
		if($leave_days <= 0)
	{
	    echo "<script>alert('YOU HAVE EXCEEDED YOUR LEAVE LIMIT. STILL YOU CAN APPLY FOR LEAVE APPLICATION UNDER LWP (Leave Without Pay)');</script>";
	  }
				...
				<div style="margin-left: 50px; margin-right: 50px;" class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							...
							<p class="mb-20">NOTE : 6CL , 6SL , 6PL annually</p>
						</div>
					</div>
